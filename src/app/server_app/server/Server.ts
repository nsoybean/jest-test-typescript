...
export class Server {
  // directly initializes for each instance of server as compared to having a contructor.
  // unit testing is slightly more difficult.
  // look at example of 'UserCredentialsDataAccess' and its test
  private server: NodeServer
  private authorizer = new Authorizer()
  private reservationsDataAccess = new ReservationsDataAccess()

  // note this method is async, test have to be async too
