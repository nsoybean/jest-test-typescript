...
// inject mocks
// this type of mock injection is required for test of consumer classes
jest.mock('../../../app/server_app/data/SessionTokenDataAccess', () => {
  return {
    // return constructor object as it will be used by test
    SessionTokenDataAccess: jest.fn().mockImplementation(() => {
      // return methods that this mocked class requires
      return {
